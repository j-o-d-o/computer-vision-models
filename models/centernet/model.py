...
def create_model(params: CenternetParams) -> tf.keras.Model:
    ...
    if params.REGRESSION_FIELDS["r_offset"].active:
        ...
        offset = Conv2D(params.REGRESSION_FIELDS["r_offset"].size, (1, 1), padding="valid", activation=None, name=f"{namescope}r_offset")(offset)
    ...
    if params.REGRESSION_FIELDS["fullbox"].active:
        ...
        fullbox = Conv2D(params.REGRESSION_FIELDS["fullbox"].size, (1, 1), padding="valid", activation=None, name=f"{namescope}fullbox")(fullbox)
    ...
    if params.REGRESSION_FIELDS["l_shape"].active:
        ...
        l_shape = Conv2D(params.REGRESSION_FIELDS["l_shape"].size, (1, 1), padding="valid", activation=None, name=f"{namescope}lshape")(l_shape)
    ...
    if params.REGRESSION_FIELDS["3d_info"].active:
        ...
        radial_dist = Conv2D(1, (1, 1), padding="valid", activation=None, name=f"{namescope}dist")(radial_dist)
        ...
        orientation = Conv2D(1, (1, 1), padding="valid", activation=None, name=f"{namescope}orientation")(orientation)
        ...
        obj_dims = Conv2D(3, (1, 1), padding="valid", activation=None, name=f"{namescope}dims")(obj_dims)

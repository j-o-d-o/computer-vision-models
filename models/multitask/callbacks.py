...
class ShowPygame():
    ...
    def show(self, inp, y_true, y_pred):
        ...
        # Slice data
        # --------------------------------
        y_true_depth = y_true[0][:, :, self.depth_offset["y_true"][0]:self.depth_offset["y_true"][1]]
        y_pred_depth = y_pred[0][:, :, self.depth_offset["y_pred"][0]:self.depth_offset["y_pred"][1]]
